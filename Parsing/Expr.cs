...
namespace LoxSharp.Parsing
{
    ...
    internal interface IExprVisitor<T>
    {
        ...
        public T VisitAssignment(Expr.Assignment assignment);
    ...
    internal abstract partial class Expr
    {
        ...
        public abstract T Accept<T>(IExprVisitor<T> visitor);
            ...
            public sealed partial class Assignment: Expr
            {
                public Token Left { get; set; }
                public Expr Value { get; set; }
                public Assignment(Token left, Expr value)
                {
                    Left = left;
                    Value = value;
                }
                public override void Accept(IExprVisitor visitor) => visitor.VisitAssignment(this);
                public override T Accept<T>(IExprVisitor<T> visitor) => visitor.VisitAssignment(this);
            }
